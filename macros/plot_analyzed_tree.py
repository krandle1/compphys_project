...
c3.Divide(2,1)
c3.cd(1)
rA1vrA2.GetYaxis().SetRangeUser(-10,30)
rA1vrA2.GetXaxis().SetRangeUser(0,35)
rA1vrA2.Draw('COLZ')
c3.cd(2)
rA1vrA2av.GetYaxis().SetRangeUser(-3,3)
rA1vrA2av.GetXaxis().SetRangeUser(0,35)
rA1vrA2av.Draw()
...
c4.Divide(2,1)
c4.cd(1)
b1vrA2.GetYaxis().SetRangeUser(-10,30)
b1vrA2.Draw('COLZ')
c4.cd(2)
b1vrA2av.GetYaxis().SetRangeUser(-3,3)
b1vrA2av.Draw()
